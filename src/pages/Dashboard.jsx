      ...
      <section className="dash-section"> 
        ...
        <Link to="/learn/1" className="continue-card"> 
          <div className="continue-card-top"> 
            ...
            sytle={{ background: '#f8982022', color: '#f89820' }}>
              <CodeXml />
               Intro to JavaScript</span> 
            <span>50%</span> 
          </div> 
          <h3 className="continue-title">Getting Started with Variables</h3>
          <div className="progress-bar-track"> 
            <div className="progress-bar-fill" style={{ width: '50%', background: '#f89820' }} />
          </div>
